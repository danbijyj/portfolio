export const worksData = [
    ...
    },
    {
        ...
        skill2: 'React',
        type: 'personal',
        desc: '공공데이터 REST API를 활용해 경기도 공공 도서관 정보를 조회하는 웹 애플리케이션을 구현했습니다. fetch를 사용해 데이터를 비동기로 가져오고, API 응답 데이터를 원본 상태로 유지한 뒤 지역 필터링, 검색, 정렬, 더보기 페이지네이션을 파생 상태로 분리해 처리했습니다. 검색 입력에는 debounce를 적용해 불필요한 연산을 줄였고, API 키를 환경변수로 관리해 보안을 고려했습니다. 데이터 흐름과 상태 분리를 중심으로 구조를 설계해 외부 API를 안정적으로 활용할 수 있도록 구현했습니다.',
        details: {
