export const skillsData = [
    {
        ...
        items: [
            ...
            { name: 'Illustrator', icon: '/images/icon_03.png' },
        ],
    },
    {
        type: 'basic',
        ...
        items: [
            ...
            { name: 'CSS', icon: '/images/icon_05.png' },
            { name: 'SCSS', icon: '/images/icon_06.png' },
        ...
        groups: [
            {
                title: 'Backend',
                items: [
                    { name: 'Express.js', icon: '/images/icon_14.png' },
                    { name: 'Node.js', icon: '/images/icon_15.png' },
                ],
            },
            {
                title: 'Server',
                items: [{ name: 'AWS', icon: '/images/icon_16.png' }],
            },
            {
                title: 'Collaboration',
                items: [
